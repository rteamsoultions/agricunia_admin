...
import StelaStationResult from './StelaStationResult';





function StelaStation() {
...
<>
    <div className="p-0">
        ...
        <Col className="w-100">
            <Row>
                <Col md={12}><h1 className="text-white">stela station</h1></Col>
