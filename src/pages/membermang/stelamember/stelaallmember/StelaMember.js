...
import StelaMemberList from './StelaMemberList';

function StelaMember() {
...
<>
    <div className="p-0">
        ...
        <Col className="w-100">
            <Row>
                <Col md={6}><h1 className="text-white">Stela Member</h1></Col>
            ...
            <Row>
                ...
                <Form.Row className="stela-row m-0">
                    ...
                    <div className="p-2">
                        <SelectOption 
                        disabled data={[ 
                            {value: 1, label: 'Hong Gildong' }, 
                            {value: 2, label: 'Hong Gildong' } ]} 
                            onChange={handleDropdown} 
                            name="selectstelaname" 
                            defauultvalue="Name" 
                            styleClass="drop-down-margin" />
                    </div>
