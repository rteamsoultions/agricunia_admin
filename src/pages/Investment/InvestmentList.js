...
function InvestmentList() {
    ...
    const user_data = [
        {
            id: "1",
            Invest_Name: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.",
            Invest_des: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.",
            Cycle: "3 Months",
            Target: "3 tonnes per hectare",
            Price: "$10",
            Loction: "Nigeria",
            ROI: "50%",
    ...
    const play_head = [
        ...
        {
            dataField: "Invest_Name",
            text: "Product-Name",
        },
        {
            dataField: "Invest_des",
            text: "Invest-Des",
        },
        {
            dataField: "Cycle",
